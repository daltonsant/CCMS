...
namespace CCMS.NEOPE.Infra.Data.Migrations
{
    ...
    [Migration("20220901163305_AddOrderToTasks")]
    partial class AddOrderToTasks
    {
            ...
            modelBuilder.Entity("CCMS.NEOPE.Domain.Entities.TaskCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 251, DateTimeKind.Local).AddTicks(4694),
                            Name = "Civil"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 251, DateTimeKind.Local).AddTicks(4699),
                            Name = "Eletromecânico"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 251, DateTimeKind.Local).AddTicks(4700),
                            Name = "Aterramento"
                        },
                        new
                        {
                            Id = 4,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 251, DateTimeKind.Local).AddTicks(4702),
                            Name = "Projeto"
                        },
                        new
                        {
                            Id = 5,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 251, DateTimeKind.Local).AddTicks(4703),
                            Name = "Painéis"
                        },
                        new
                        {
                            Id = 6,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 251, DateTimeKind.Local).AddTicks(4705),
                            Name = "Equipamentos"
                        },
                        new
                        {
                            Id = 7,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 251, DateTimeKind.Local).AddTicks(4706),
                            Name = "Interligações"
                        },
                        new
                        {
                            Id = 8,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 251, DateTimeKind.Local).AddTicks(4707),
                            Name = "SPCS"
                        });
                });
            ...
            modelBuilder.Entity("CCMS.NEOPE.Domain.Entities.TaskStep", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 246, DateTimeKind.Local).AddTicks(8032),
                            Name = "Planejamento"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 246, DateTimeKind.Local).AddTicks(8044),
                            Name = "TAC Equip. Interlig."
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 246, DateTimeKind.Local).AddTicks(8045),
                            Name = "TAF SPCS"
                        },
                        new
                        {
                            Id = 4,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 246, DateTimeKind.Local).AddTicks(8047),
                            Name = "TAC SPCS"
                        },
                        new
                        {
                            Id = 5,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 246, DateTimeKind.Local).AddTicks(8048),
                            Name = "Energização"
                        },
                        new
                        {
                            Id = 6,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 246, DateTimeKind.Local).AddTicks(8049),
                            Name = "SAP"
                        });
                });
            ...
            modelBuilder.Entity("CCMS.NEOPE.Domain.Entities.TaskType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1ul,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 251, DateTimeKind.Local).AddTicks(3902),
                            Name = "Informativo"
                        },
                        new
                        {
                            Id = 2ul,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 251, DateTimeKind.Local).AddTicks(3913),
                            Name = "Acompanhamento"
                        },
                        new
                        {
                            Id = 3ul,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 251, DateTimeKind.Local).AddTicks(3915),
                            Name = "Pendência não impeditiva"
                        },
                        new
                        {
                            Id = 4ul,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 251, DateTimeKind.Local).AddTicks(3916),
                            Name = "Pendência impeditiva"
                        },
                        new
                        {
                            Id = 5ul,
                            CreateDate = new DateTime(2022, 9, 1, 13, 33, 5, 251, DateTimeKind.Local).AddTicks(3918),
            ...
            modelBuilder.Entity("CCMS.NEOPE.Infra.Identity.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "066766ef-a5ea-40ee-997a-22e7328c668c",
                            ConcurrencyStamp = "2e2f6529-165b-4ebf-bf72-02cbace794d5",
                        ...
                        new
                        {
                            Id = "8f04e1da-bd81-444a-b8f3-8b1711fc11b0",
                            ConcurrencyStamp = "4225326f-7730-42ea-bc0c-6c55149d06c5",
